...
int main(int argc, char *argv[])
{
    ...
    while (1)
    {
        ...
        {
            // errorCode = parseInput("copy_in test.txt", cwd);
            // errorCode = parseInput("cat test.txt", cwd);

            // errorCode = parseInput("copy_out test.txt", cwd);
            // errorCode = parseInput("recover 2", cwd);
            errorCode = parseInput("defragment", cwd);

            // errorCode = parseInput("fragmentation_degree", cwd);
            break;
        }
    }
